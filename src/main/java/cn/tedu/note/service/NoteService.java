...
public interface NoteService {
	...
	Note addNote(String userId,String notebookId,String title)throws NotebookNotFoundException, UserNotFoundException;
	
	//增加批量删除的方法
	int deleteAll(String... noteId); //String... 称为变长参数,本质与String[]完全一样
	//变长参数调用: 
	//  		deleteAll("1")
	//			deleteAll("1","2")
	//			deleteAll("1","2","3")
